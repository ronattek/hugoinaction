...
document.addEventListener("DOMContentLoaded",()=>{eleCheckbox=document.getElementsByClassName('hamburger')[0];eleSearch=document.querySelector('#searchbox input');eleHeader=document.getElementById('header');eleScroll=document.querySelector('.scroll-up');document.addEventListener('scroll',onScroll,false);});let color=window.localStorage.color||'#4f46e5';function setColor(hex){color=hex;window.localStorage.color=color;document.documentElement.style.setProperty("--theme-color",hex);}
